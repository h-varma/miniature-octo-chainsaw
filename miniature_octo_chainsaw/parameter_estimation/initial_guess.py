...
class InitialGuessGenerator:
    def __init__(self, model: object):
        ...
        self.bifurcation_point = find_bifurcation_point(x0=self.steady_state, **kwargs)
        ...
        self.bifurcation_points = trace_measured_bifurcations(x0=self.bifurcation_point, **kwargs)
